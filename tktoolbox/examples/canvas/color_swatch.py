...
class ColorPanel(Frame):
    ...
    def mouseEnter(self, event):
        ...
        for x in [160, 310, 460]:
            self.canvas.create_line(x, 563, x + 50, 563, x + 50, 587, x + 140,
                                    587, width=2, fill=filler, tags='linex')
        self.canvas.itemconfig(self.backg, fill=filler)
        for x, color in [(610, 'white'), (630, 'black'), (650, 'red'),
                         (670, 'yellow'), (690, 'blue'), (710, 'green')]:
            self.canvas.create_line(x, 563, x + 50, 563, x + 50, 587, x + 140,
                                    587, width=2, fill=color, tags='linex')
